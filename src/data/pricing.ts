...
export const pricingPlans: PricingPlan[] = [
  {
    ...
    features: [
      ...
      { text: "Checkout website dan kontak utama", included: true },
      ...
      { text: "Sistem keranjang pemesanan", included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Tombol pesan per produk", included: true },
      { text: "Sistem keranjang pemesanan", included: true },
      { text: "Bantuan Custom Domain", included: true },
      { text: "Bantuan Deploy Website", included: true },
  ...
  },
  {
    ...
    description: "Solusi website personal untuk menampilkan profil profesional, portofolio proyek, dan kontak langsung.",
    popular: false,
    deliveryTime: "3-5 Hari Kerja",
    ...
    features: [
      ...
      { text: "Tombol kontak dan konsultasi", included: true },
  ...
  },
  {
    ...
    description: "Website toko online sederhana dengan katalog, detail produk, keranjang ringan, dan checkout langsung melalui website.",
    popular: true,
    ...
    features: [
      ...
      { text: "Checkout langsung melalui website dengan pilihan pembayaran otomatis atau manual.", included: true },
      { text: "Filter produk dan kategori", included: true },
      { text: "Bantuan Custom Domain", included: true },
      { text: "Bantuan Deploy Website", included: true },
      { text: "Manajemen produk mudah", included: true },
      { text: "Sistem ringkasan pesanan otomatis", included: true },
      { text: "Revisi Desain", included: true }
    ]
  },
  {
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Responsif di semua perangkat", included: true },
      { text: "Dukungan checkout website dan konsultasi", included: true },
      { text: "Bantuan Deploy Website", included: false },
